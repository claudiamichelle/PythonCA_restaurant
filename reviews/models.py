...
class Choice(models.Model):
    ...
    choice_comment = models.CharField(max_length=200,blank=True, null=True)
    choice_user_id  = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE)
